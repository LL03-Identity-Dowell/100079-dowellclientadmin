...
from .views import sessionView,OrgView,OrgsView,DeviceLayers,OsLayers,BrowserLayers,ConnectionLayers,LoginLayers,IdVerificationLayers,PasswordLayers,GetPort
urlpatterns = [
